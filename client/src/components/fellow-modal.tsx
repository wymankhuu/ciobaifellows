    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[90vh] md:h-[85vh] p-0 gap-0 border-none shadow-2xl bg-[#fafafa] flex flex-col overflow-hidden">
        <div className="flex flex-col md:grid md:grid-cols-[300px_1fr] h-full overflow-hidden">
          {/* Sidebar */}
          <div className="bg-primary/5 p-8 flex flex-col gap-6 border-b md:border-b-0 md:border-r border-border/50 overflow-y-auto shrink-0 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          {/* Main Content */}
          <div className="p-8 space-y-8 overflow-y-auto h-full scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
              {/* Video/Image Section */}
